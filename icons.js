 ...
 * 
 * Usage in HTML: <span class="icon" data-icon="moon"></span>
 * Or call: Icons.render('moon', { size: 20, class: 'my-class' })
 */
...
const ICON_PATHS = {
  ...
  // Checklist (replaces ✅ in guide lists)
...
window.Icons = {
  ...
  /**
   * Returns an SVG string sized and classed as requested.
   * The SVG itself uses currentColor, so it inherits CSS color automatically.
   */
  ...
  /**
   * Replace all <span data-icon="name"> elements in the document.
